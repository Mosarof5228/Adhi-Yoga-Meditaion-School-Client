        ...
        <footer>
            <div className="footer p-10 bg-neutral text-neutral-content">
                <div>
                    ...
                    <p>A.Y Meditation School<br />Providing reliable tech since 1992</p>
                </div>
                <div>
            ...
            <p className='footer-center p-4 bg-base-400 text-base-content bg-[#2d3c58] text-white'>Copyright © 2023 - All right reserved by ACME Industries Ltd</p>
        </footer>
    );
};
